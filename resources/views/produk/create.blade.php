...
<header class="container-header mb-4"
    ...
    <h2 class="text-white">Form Tambah Produk</h2>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 order-lg-1">
            <div class="contact-form__wrapper p-5 shadow-lg">
                <form action="{{ route('produk.store') }}" method="POST" class="contact-form form-validate" novalidate
                    ...
                    <div class="mb-4">
                        <label class="required-field text-white" for="image">Foto</label>
