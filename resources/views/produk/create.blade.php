                    ...
                    <h4>&nbsp; Tambah produk</h4>
                      <div class="row no-gutters">
                          ...
                          <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                              <form action="{{ route('produk.store') }}" method="POST" class="contact-form form-validate" novalidate="novalidate" enctype="multipart/form-data"  >
                                {{ csrf_field() }}
                                @csrf
                                @if ($errors->any())
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6 mb-3">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="NamaProduk" name="NamaProduk" value="{{ old('NamaProduk') }}" placeholder="Name Produk">
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-sm-6 mb-3">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="Harga" name="Harga" value="{{ old('Harga') }}" placeholder="RP,0.000">
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-sm-6 mb-3">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="Stok" name="Stok" value="{{ old('Stok') }}" placeholder="Name Produk">
                                          </div>
                                      </div>
                  
                                      <div class="col-sm-6 mb-3" margin-left: 10px;>
                                          <div class="form-group">
                                              <label class="required-field" for="image">Foto</label>
