...
{{--                
                      ...
                      <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                          <form action="{{ route('member.store') }}" method="POST"class="contact-form form-validate" novalidate="novalidate">
                            {{ csrf_field() }}
                            @csrf
                              <div class="row">
                                  <div class="col-sm-6 mb-3">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="NamaPelanggan" name="NamaPelanggan" value="{{ old('NamaPelanggan') }}" placeholder="Name Member">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-6 mb-3">
                                      <div class="form-group">
                                          ...
                                          <textarea class="form-control" id="Alamat" name="Alamat" rows="4" placeholder="Masukan alamat member di sini!!"></textarea>
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-sm-6 mb-3" style="margin-top: -78px;">
                                      <div class="form-group">
                                          ...
                                          <input type="tel" class="form-control" id="NomorTelepon" name="NomorTelepon" placeholder="08XXXXXXX">
                                      </div>
                                  </div>
