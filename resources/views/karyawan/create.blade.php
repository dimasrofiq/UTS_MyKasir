...
<header class="container-header mb-4"
    ...
    <h2 class="text-white">Form Tambah Karyawan</h2>
</header>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 order-lg-1">
            <div class="contact-form__wrapper p-5 shadow-lg">
                <form action="{{ route('karyawan.store') }}" method="POST" class="contact-form form-validate" novalidate
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}"
                            placeholder="Karyawan@example.com" required>
                    </div>
                    <div class="mb-4">
