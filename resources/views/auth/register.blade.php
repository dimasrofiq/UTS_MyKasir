...
{{--  <form action="{{ route('store') }}" method="POST">
    ...
    <label>Password confimation</label><br>
    <input type="password" id="password" name="password_confirmation"><br><br>
    <input type="submit" value="Register">
</form>  --}}

<section class="vh-70" style="margin-top: -23px;">
    <div class="container h-501px">
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="{{ route('store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-space-between mx-4 mb-3 mb-lg-4">
                      <input type="submit" class="btn btn-primary btn-lg" value="Register">
                      <br>
                      <a href="{{ route('login') }}" class="btn btn-primary btn-lg" style="margin-left: 150px;">Kembali</a>
                    </div>
