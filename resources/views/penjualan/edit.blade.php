...
<header class="container-header mb-4"
    ...
    <h2 class="text-white">Edit Penjualan</h2>
</header>
        ...
        <div class="col-lg-5 order-lg-2">
            <div class="contact-info__wrapper gradient-brand-color p-5 shadow-lg">
                ...
                <div class="alert alert-dark" role="alert">
                    <span class="text-black">Pastikan data Penjualan yang Anda ubah telah benar dan sesuai!</span>
                </div>
                ...
                <form action="{{ route('penjualan.update', $penjualan->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" class="form-control" id="TotalHarga" name="TotalHarga" placeholder="Rp 0.000"
                            value="{{ $penjualan->TotalHarga }}" required>
                    </div>
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="PelangganId" required>
                            ...
                            @forelse ($pelanggans as $pelangan)
                                <option value="{{ $pelangan->id }}" {{ $penjualan->PelangganId == $pelangan->id ? 'selected' : '' }}>{{ $pelangan->NamaPelanggan }}</option>
                            @empty
